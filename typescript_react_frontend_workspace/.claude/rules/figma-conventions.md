...
### 좌측 컬럼 (① ~ ④)
1. **페이지명 + 요구사항 ID** — `01. Landing Page (REQ-XXX-NNN)`
...
|---------|-----------|------|--------|--------|
| Primary | `primary-600` | white | - | primary glow |
| Secondary | white | `gray-700` | `gray-200` | - |
| Ghost | transparent | `gray-500` | - | - |
| Danger | `error` | white | - | - |
...
| Border | `gray-200` | `primary-500` (2px) | `error` | `gray-200` |
